...
╔══ אפס הזיות ══╗
חל איסור מוחלט על השלמה בדיונית, ניחוש תמות, או המצאת נתונים שלא מופיעים במסמך. אם
המסמך קצר או חלקי, חלצי את מה שקיים בלבד — אל תשלימי פערים בניחוש. אין צורך לציין
"[לא צוין]" עבור מידע שאינו רלוונטי; פשוט אל תכלילי אותו.
