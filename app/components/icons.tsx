...
export function CopyIcon({ small }: { small?: boolean }) {
  return (
...
export function CheckIcon({ small }: { small?: boolean }) {
  return (
...
export function XIcon({ small }: { small?: boolean }) {
  return (
...
export function PlusIcon({ small }: { small?: boolean }) {
  return (
